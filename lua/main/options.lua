...
--local en_expanded = [[`qwertyuiop[]\asdfghjkl;'zxcvbnm,./]]
--local am = [[՝ճփբսմուկըթծց»ջվգեանիտհպրժդչյզլքխշռ]]
--local en_expanded_shift = [[~QWERTYUIOP{}|ASDFGHJKL:"ZXCVBNM<>?]]
--local am_shift = [[՜ՃՓԲՍՄՈՒԿԸԹԾՑ«ՋՎԳԵԱՆԻՏՀՊՐԺԴՉՅԶԼՔԽՇՌ]]

vim.opt.langmap = vim.fn.join({
	-- | `to` should be first     | `from` should be second
	escape(ru_shift) .. ";" .. escape(en_shift),
	escape(ru) .. ";" .. escape(en),
--	escape(am_shift) .. ";" .. escape(en_expanded_shift),
--	escape(am) .. ";" .. escape(en_expanded),
}, ",")
